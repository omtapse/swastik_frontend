...
const EditProgramForm = Loadable(lazy(() => import('../views/apps/programs/EditProgramForm')))
const EditPillarForm = Loadable(lazy((() => import('../views/apps/pillars/EditPillarForm'))))
const EditViharForm = Loadable(lazy(() => import('../views/apps/vihars/EditViharForm')))
const EditGurusForm = Loadable(lazy(() => import('../views/apps/gurus/EditGurusForm')))
...
const Router = [
  {
    ...
    children: [
      ...
      { path: '/apps/programs/programs-form', element: <ProgrampageForm /> },
      { path: '/apps/programs/programs-list', element: <ProgrampageList />},
      { path: '/apps/programs/updatePrograms-list', element: <EditProgramForm />},
      { path: '/apps/gurus/gurus-form', element: <GuruspageForm />},
      { path: '/apps/gurus/gurus-list', element: <GuruspageList />},
      { path: '/apps/vihars/vihar-form', element: <ViharspageForm />},
      { path: '/apps/vihars/vihar-list', element: <ViharspageList /> },
      { path: '/apps/pillars/pillar-form', element: <PillarsPageForm />},
      { path: '/apps/pillars/pillar-list', element: <PillarsPageList />},
      { path: '/apps/pillars/updatePillars-form', element: <EditPillarForm />},
      { path: '/apps/vihars/updateVihar-form', element: <EditViharForm />},
      
      { path: '/apps/gurus/updateGuru-form', element: <EditGurusForm />},
